...
class CommandLineApplication:
    def __init__(self):
        self.cli_app = argparse.ArgumentParser(
            description="Export all images from a powerpoint lecture (.pptx) into a "
            "directory"
        )
        self.cli_app.add_argument(
            "pptx_file_path",
            metavar="<pptx file>",
    ...
    def execute(self):
        ...
        try:
            ...
            logging.exception(
                "An exception occurred when verifying your pptx file", exc_info=True
            )
        try:
        ...
        try:
            ...
            logging.exception(
                "An exception occurred when exporting the images", exc_info=True
            )
