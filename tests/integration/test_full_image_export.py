...
def test_powerpoint_images_are_the_same_as_the_number_in_the_file(tmp_path, minimal_pres):
...
def test_if_all_images_from_an_actual_presentation_are_extracted_to_directory(default_path, minimal_pres):
